...
namespace Microsoft.BotBuilderSamples
{
    public class AddToDoDialog : ComponentDialog
    {
        ...
        {
            var fullPath = Directory.EnumerateFiles(".", $"{nameof(AddToDoDialog)}.qna.json", SearchOption.AllDirectories).First();
        ...
        private static Recognizer CreateQnAMakerRecognizer(IConfiguration configuration)
        {
            ...
            {
                throw new Exception("NOTE: QnA Maker is not configured for AddToDoDialog. Please follow instructions in README.md. To enable all capabilities, add 'qnamaker:qnamakerSampleBot_en_us_qna', 'qnamaker:LuisAPIKey' and 'qnamaker:endpointKey' to the appsettings.json file.");
            }
